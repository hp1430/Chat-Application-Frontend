...
import { useJoinWorkspaceRequest } from '@/hooks/workspaces/useJoinWorkspace';
...
export const JoinPage = () => {
    ...
    return (
        <div
            className="h-[100vh] flex flex-col gap-y-8 items-center justify-center bg-white rounded-lg shadow-sm" 
        >
            <div
